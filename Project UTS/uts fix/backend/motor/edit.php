                            ...
                            <div class="card-body">
                                <div class="container">
                                    ...
                                    <input type="hidden" name="idedit" value="<?=$result['id']?>" >
                                        ...
                                        <div class="form-group">
                                            <label for="tipe_motor_id" class="form-label">ID Tipe Motor</label>
                                            <input id="tipe_motor_id" name="tipe_motor_id"  value="<?=$result['tipe_motor_id']?>" type="text" class="form-control" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="merk_id" name="merk_id"  value="<?=$result['merk_id']?>" type="text" class="form-control" required>
                                        </div>
